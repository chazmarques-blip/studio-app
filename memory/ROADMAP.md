...
## P0 - Critical (Done)
- [x] Backend syntax fix
- [x] Sora 2 Cinema Sequential mode
- [x] Dialogue reaching Sora 2 (no truncation)
...
- [ ] Per-scene music mood editing
- [ ] Real-time production progress websocket
- [ ] Video preview in browser (chunked streaming)
